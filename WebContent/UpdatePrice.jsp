...
<h1>Update Price</h1>
<br>
	<form action="http://18.224.15.115/foodservlet/UpdatePrice" method="post">
		...
		<br>
		<input type="hidden" name="foodID" id="foodID" value=<%=request.getParameter("foodID") %> > 
		<button type="submit" style="margin-top:10px;margin-left:5px; background-color:red; color: white; " class="btn btn-lg ">Apply Update</button>
