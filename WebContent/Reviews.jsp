...
<body>
  ...
  <br>
     ...
     <div >
         ...
         <a id="addReview" href=<%= "\"/foodservlet/AddReview?foodID=" + request.getParameter("foodID") + "\"" %> class="btn btn-danger float-right">
    ...
    <h1 style="justify-content: center"><%=request.getAttribute("foodName")%> </h1>
    <h4 class=" text-muted"><%=request.getAttribute("restName")%></h4>
    <br />
    <h3>
       ...
       <h4 class="text-muted"><%=request.getAttribute("totalReviews")%> reviews</h4>
   <%@page import="java.util.ArrayList"%>      <%--Importing all the dependent classes--%>
    ...
    <% for(int i =  0; i < ReviewList.size() ; i++){ %>
    	<%if(ReviewList.get(i).belongsToCurrentUser){ %>
    				<input type="hidden" id="belongsToCurrentUser" name="belongsToCurrentUser" value = true>
    	<% } %>
        <div class="list-group-item flex-column align-items-start">
            ...
            <div class="d-flex w-100 justify-content-between">
	            ...
	            <h5  class="mb-1"><%=ReviewList.get(i).getAuthor()%></h5>
